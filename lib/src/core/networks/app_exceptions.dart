...
class BusinessException {
  ...
  factory BusinessException.fromJson(Map<String, dynamic> json) =>
      BusinessException(errorCode: json['error-code'] as int, errors: json['errors'] as Map<String, dynamic>, message: json['message'] as String);
  final int errorCode;
  final Map<String, dynamic> errors;
  final String message;

  String toString() {
    return "Business Exception :\n" + jsonEncode({'errorCode': errorCode, 'message': message, 'errors': errors});
  }
