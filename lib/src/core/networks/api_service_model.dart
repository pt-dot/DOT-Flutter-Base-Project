...
class ApiServiceModel<T> {
  ...
  ApiServiceModel.fromResponseForList(Response response, T Function(List) fromJson) {
    final dataResponse = response.data as Map<String, dynamic>;
  ...
  ApiServiceModel.fromList(Response response, T Function(List<dynamic>) fromJson) {
