class TextSize {
  ...
  static const double addressTextSize = 8;
}

class MarginSize {
  static const double defaultMargin = 32;
  static const double smallMargin = 12;
  static const double smallMargin2 = 14;
  static const double sixPixel = 6;
}

class IconSize {
  static const double defaultSize = 24;
  static const double superSmallSize = 12;
...
class BorderSize {
  static const double smallBorder = 5;
  static const double semiSmallBorder = 10;
  static const double regularBorder = 15;
  static const double largeBorder = 20;
}
